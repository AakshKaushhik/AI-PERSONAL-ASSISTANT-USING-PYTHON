...
print("Loading AKSHs AI personal assistant - andrew")
...
speak("Loading AKSH's AI personal assistant andrew")
wishMe()
...
if __name__=='__main__':
    ...
    while True:
        ...
        if "good bye" in statement or "ok bye" in statement or "stop" in statement:
            speak('your personal assistant andrew is shutting down,Good bye')
            print('your personal assistant andrew is shutting down,Good bye')
            break
        ...
        if 'wikipedia' in statement:
            ...
            speak("I was built by AKSH")
            print("I was built by AKSH")

        elif "how are you" in statement or "whatsup" in statement:
